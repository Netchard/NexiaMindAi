...
const indexer_1 = require("../src/lib/supabase/storage/indexer");
/**
...
async function main() {
    ...
    try {
        ...
        logger_1.logger.info('Script d\'indexation Supabase Storage');
        logger_1.logger.info('='.repeat(60));
        ...
        const indexer = options.bucket !== 'documents'
            ? new indexer_1.SupabaseStorageIndexer(options.bucket)
            : indexer_1.storageIndexer;
        ...
        logger_1.logger.error('Echec du script d\'indexation', {
            error: error.message,
            stack: error.stack,
        });
        console.error('\n' + '='.repeat(60));
